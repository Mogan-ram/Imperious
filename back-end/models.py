...
try:
    ...
    # After initializing MongoDB client and database, add these collections:
...
class Connection:
    ...
    def get_user_connections(user_id):
        ...
        """
        try:
            # Find all accepted connections where this user is either user1 or user2
            connections = list(
    ...
    def create_connection(user1_id, user2_id):
        ...
        try:
            ...
            result = connections_collection.insert_one(new_connection)
            return str(result.inserted_id)
        except Exception as e:
    ...
    def remove_connection(connection_id, user_id):
        ...
        try:
            ...
            print(f"Error in remove_connection: {str(e)}")
            return False


# Add ConnectionRequest class
class ConnectionRequest:
    ...
    def create_request(from_user_id, to_user_id):
        ...
        try:
            ...
            raise Exception(f"Failed to create connection request: {str(e)}")
